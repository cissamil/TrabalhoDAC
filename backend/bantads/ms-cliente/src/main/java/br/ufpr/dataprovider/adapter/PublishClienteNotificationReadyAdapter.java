...
public class PublishClienteNotificationReadyAdapter implements PublishClienteNotificationReadyOutputPort {
  ...
  @Override
  public void publish(String email, String clienteId, String content){
    ...
    try{
      ...
      sendEmailMessage.setReceiverId(clienteId);
      sendEmailMessage.setSubject("Há novas informações sobre a sua conta!");
